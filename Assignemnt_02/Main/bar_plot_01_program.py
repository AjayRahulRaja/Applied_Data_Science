...
France_1960['Population growth (annual %)']
...
uk_1960['Population growth (annual %)']
...
india_1960['Population growth (annual %)']
...
japan_1960['Population growth (annual %)']
...
cuba_1960['Population growth (annual %)']
...
colombia_1960['Population growth (annual %)']
...
iraq_1960['Population growth (annual %)']
...
algeria_1960['Population growth (annual %)']
...
australia_1960['Population growth (annual %)']
...
bar_plot.plot(x='Country_Name',
              kind='bar',
              stacked=False,
              title='Urban Population Over Years', figsize=(10,5))
