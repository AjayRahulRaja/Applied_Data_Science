...
plt.title("IMDB score for films produced between 1950 to 1990 in the United States", size=14, y=0.991)
...
plt.title("IMDB score for films produced between 1990 to 2020 in the United States", size=14, y=0.991)
plt.xlabel("IMDB score")
plt.ylabel("Number of films")
plt.show()